...
# Filled in by the user of this script
private_key  =  '<Sender Private Key>'
from_address  =  '<Sender Public Address>'

# Parameters of this script (replace hardcoded below with product new release)
fileProductId = 0
fileSha256 = '0x00'
fileUri = 'https://'
fileVersion = 1
...
web3.eth.account.sign_transaction(newRelease, private_key=private_key)
